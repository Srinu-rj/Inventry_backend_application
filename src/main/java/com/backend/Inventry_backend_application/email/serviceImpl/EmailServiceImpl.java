...
import static com.backend.Inventry_backend_application.email.config.EmailUtils.getEmailMessage;
import static com.backend.Inventry_backend_application.email.config.EmailUtils.getVerificationUrl;
